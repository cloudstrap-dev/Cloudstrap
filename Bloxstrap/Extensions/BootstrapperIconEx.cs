    ...
    static class BootstrapperIconEx
    {
        ...
        public static Icon GetIcon(this BootstrapperIcon icon)
        {
            ...
            if (icon == BootstrapperIcon.IconCustom)
            {
                ...
                return customIcon ?? Properties.Resources.IconNyxstrap;
            }

            return icon switch
            {
                BootstrapperIcon.IconNyxstrap => Properties.Resources.IconNyxstrap,
                ...
                _ => Properties.Resources.IconNyxstrap
            };
        }
    }
}
